...
const editedText = FooladvandTranslation.split("\n");
const editedText2 = editedText.map((item) => {
  return item.replaceAll(".", "");
});
const editedText3 = editedText2.map((item) => {
  return item.replaceAll("[", "(");
});
const fooladvandTranslation = editedText3.map((item) => {
  return item.replaceAll("]", ")");
});
export default fooladvandTranslation;
